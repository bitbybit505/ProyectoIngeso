...
<div class="container-fluid custom-container">
  <div class="row">
    <nav class="col-md-2 d-none d-md-block lateral-bar sidebar rounded-bottom shadow">
      ...
      <div class="container-fluid col-md-6 justify-content-center pt-bitbybit">
        <div class="card">
          ...
          <div class="card-body">
            <form method="POST" action="database/validate-user.php" onsubmit="return validateForm();">
              ...
              <button type="submit" class="btn btn-primary mbb-bitbybit">Agregar</button>
            </form>
            <?php
